...
package com.github.matteof04.pocketapi.exceptions

import com.github.matteof04.pocketapi.util.PocketError
import io.ktor.client.statement.*

class PocketException(
    val response: HttpResponse,
    val pocketError: PocketError
) : Exception(pocketError.toString())
