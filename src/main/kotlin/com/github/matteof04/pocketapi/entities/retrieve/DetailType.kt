...
import com.github.matteof04.pocketapi.entities.retrieve.serializers.DetailTypeSerializer

@kotlinx.serialization.Serializable(with = DetailTypeSerializer::class)
