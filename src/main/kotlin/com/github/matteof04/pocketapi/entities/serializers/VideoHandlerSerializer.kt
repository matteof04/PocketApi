...
class VideoHandlerSerializer : KSerializer<VideoHandler> {
    override val descriptor: SerialDescriptor = PrimitiveSerialDescriptor("VideoHandler", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): VideoHandler = VideoHandler.codeValueOf(decoder.decodeInt())

    override fun serialize(encoder: Encoder, value: VideoHandler) {
