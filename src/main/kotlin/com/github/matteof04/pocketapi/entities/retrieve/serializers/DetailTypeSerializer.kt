...
import com.github.matteof04.pocketapi.entities.retrieve.DetailType
...
class DetailTypeSerializer : KSerializer<DetailType>{
    override val descriptor: SerialDescriptor = PrimitiveSerialDescriptor("DetailType", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): DetailType {
        return DetailType.valueOf(decoder.decodeString().uppercase())
    }
