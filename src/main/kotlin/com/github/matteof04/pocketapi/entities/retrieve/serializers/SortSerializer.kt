...
import com.github.matteof04.pocketapi.entities.retrieve.Sort
...
class SortSerializer : KSerializer<Sort>{
    override val descriptor: SerialDescriptor = PrimitiveSerialDescriptor("Sort", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): Sort {
        return Sort.valueOf(decoder.decodeString().uppercase())
    }
