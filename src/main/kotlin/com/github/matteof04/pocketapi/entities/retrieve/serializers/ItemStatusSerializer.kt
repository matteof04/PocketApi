...
package com.github.matteof04.pocketapi.entities.retrieve.serializers

import com.github.matteof04.pocketapi.entities.retrieve.ItemStatus
...
class ItemStatusSerializer : KSerializer<ItemStatus>{
    override val descriptor: SerialDescriptor = PrimitiveSerialDescriptor("ItemStatus", PrimitiveKind.STRING)

    override fun deserialize(decoder: Decoder): ItemStatus {
        return ItemStatus.valueOf(decoder.decodeString().uppercase())
    }

    override fun serialize(encoder: Encoder, value: ItemStatus) {
